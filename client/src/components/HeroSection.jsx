  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 -left-20 w-96 h-96 bg-blue-600/8 rounded-full blur-3xl animate-float" />
        <div className="absolute top-40 right-0 w-80 h-80 bg-indigo-600/8 rounded-full blur-3xl animate-float-delayed" />
        <div className="absolute bottom-20 left-1/3 w-72 h-72 bg-cyan-500/5 rounded-full blur-3xl animate-float" />
        <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-500/30 to-transparent animate-road-line" />
        <div className="absolute bottom-8 left-0 right-0 h-px bg-gradient-to-r from-transparent via-indigo-500/20 to-transparent animate-road-line-delayed" />
      </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12 animate-fade-in">
            <div className="mb-8 flex justify-center">
              <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600/30 to-indigo-600/20 border border-blue-500/20 flex items-center justify-center backdrop-blur-sm shadow-2xl shadow-blue-900/30">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight mb-4 leading-tight">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-400 to-cyan-400 animate-gradient-shift">
                True Price
              </span>
            </h2>
          ...
          <div className="max-w-4xl mx-auto mb-16 animate-fade-in" style={{ animationDelay: '150ms' }}>
            <div className="glass-card p-8 border-blue-500/20 relative overflow-hidden">
              ...
              <h3 className="text-center text-sm font-bold text-slate-400 uppercase tracking-[0.2em] mb-6 flex items-center justify-center gap-2">
